  ...
  return (
    <footer className="bg-gray-800 text-white w-full overflow-x-hidden">
      ...
      <div className="container mx-auto flex flex-row justify-center py-8 px-4 md:px-12 lg:px-56 gap-x-4 max-w-full">
        ...
        <div className="flex flex-col h-full w-29 justify-center">
          ...
          <div className="flex items-center justify-evenly mb-2">
            <button
              onClick={copyEmail}
              className="relative hover:scale-110 w-fit transition-transform duration-200"
            >
              <svg
            ...
            {/* Ícono de WhatsApp */}
            <a
              href="https://chat.whatsapp.com/KQiIxdhnCzj5vg4JbwIybl"
              target="_blank"
              rel="noopener noreferrer"
              className="w-fit"
            >
              <svg
                className="w-5 h-5 text-gray-400 hover:text-[#25D366] transition-colors duration-200"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
