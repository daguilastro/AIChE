              ...
              <div className="lg:w-1/3 pt-8 lg:pt-0">
                <div className="pl-0 lg:pl-0">
                  ...
                  <p className="text-white text-lg mb-6 leading-relaxed">
                    Para solicitar un libro físico, debes escribir un correo a{" "}
                    <a
                      href="mailto:aiche_fibog@unal.edu.co"
                      className="text-[#EF8C44] hover:underline font-medium"
                    >
                      aiche_fibog@unal.edu.co
                    </a>{" "}
                    con el día y la hora en la que estarás en la ubicación indicada, un miembro del AIChE te estará esperando y te entregará el tomo.
                  </p>
